...
{
    public class MoveAllTDtoUpPoss : Command

    {

        public static MoveAllTDtoUpPoss Instance { get; private set; }



        public MoveAllTDtoUpPoss()
        {
        ...
        public override string EnglishName => "MoveAllTDToUpperPosition";
            ...
            foreach (RhinoObject obj in doc.Objects)
            {
                ...
                if (obj.Attributes.LayerIndex == doc.Layers.FindName("TD").Index && DataModelHolder.Instance.Vessel.TDInitialPositionPointList.ContainsKey(obj.Name))
                {
                    ...
                    Point3d adjustedPoint = new Point3d(
                        ...
                        DataModelHolder.Instance.Vessel.TDAltitudeUpperPosition); // Set the Z coordinate to the desired value
